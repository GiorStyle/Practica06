...
public class ModalidadController {
	...
	@GetMapping("/porId/{paramId}")
	@ResponseBody
	public ResponseEntity<List<Modalidad>> listaPorId(@PathVariable("paramId") int idModalidad) {
		List<Modalidad> lista = modalidadService.listaModalidadPorId(idModalidad);
		return ResponseEntity.ok(lista);
	}
	
	@GetMapping("/porNombre/{paramNombre}")
	@ResponseBody
	public ResponseEntity<List<Modalidad>> listaPorNombre(@PathVariable("paramNombre") String nombre) {
